...
print("Average heartrate (in double) = \(averageHRD)")

//In my example the values differ only in type 80 and 80.0, in the first problem the answer is an integer, in the second a floating point. The second option is more correct in my opinion, because not always the number will be divisible by 3 without remainder
...
let percentOfGoal: Double = (steps / goal) * 100.0
print("\(percentOfGoal)% of goal")
/*:
