...
struct Height {
    var heightInInches: Double{
        didSet {
            let correctHeightInCentimeters = heightInInches * 2.54
            if heightInCentimeters != correctHeightInCentimeters {
                heightInCentimeters = correctHeightInCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let correctHeightInInches = heightInCentimeters / 2.54
            if heightInInches != correctHeightInInches {
                heightInInches = correctHeightInInches
            }
        }
    }
