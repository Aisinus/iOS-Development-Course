...
var favoriteBook = Book(title: "Bookvar", author: "Grupa avtorov", pages: 48, price: 217)
print(favoriteBook)
/*:
...
var laptop2 = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2019)
/*:
...
var myHeight = Height(heightInInches: 70.9)
